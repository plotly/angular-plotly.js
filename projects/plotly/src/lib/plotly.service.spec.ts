...
describe('PlotlyService', () => {
  ...
  it('should get a plotly instance by id', inject(
    [PlotlyService],
  ...
  it('should check the plotly dependency', inject(
    [PlotlyService],
    (service: PlotlyService) => {
      (PlotlyService as any).plotly = undefined;
      expect(() => service.getPlotly()).toThrowError(
  ...
  it('should return the plotly object', inject(
    [PlotlyService],
    (service: PlotlyService) => {
  ...
  it('should call plotly.newPlot method', inject(
    [PlotlyService],
    async (service: PlotlyService) => {
      return new Promise(async (resolve) => {
        ...
        expect(plotly.newPlot).toHaveBeenCalledWith('one', {
          data: 'two',
          layout: 'three',
          config: 'four',
          frames: 'five',
  ...
  it('should call plotly.plot method', inject(
    [PlotlyService],
    (service: PlotlyService) => {
      const plotly = service.getPlotly();
      ...
      expect(plotly.plot).toHaveBeenCalledWith('one', {
        data: 'two',
        layout: 'three',
        config: 'four',
        frames: 'five',
  ...
  it('should call plotly.update method', inject(
    [PlotlyService],
    (service: PlotlyService) => {
      const plotly = service.getPlotly();
      ...
      expect(plotly.react).toHaveBeenCalledWith('one', {
        data: 'two',
        layout: 'three',
        config: 'four',
        frames: 'five',
  ...
  it('should call plotly.Plots.resize method', inject(
    [PlotlyService],
    (service: PlotlyService) => {
      const plotly = service.getPlotly();
  ...
  it('should fail if is using an unsupported version of plotly.js', inject(
    [PlotlyService],
    () => {
      expect(() => PlotlyService.setPlotly({})).toThrowError(
        `Invalid plotly.js version. Please, use any version above 1.40.0`
      );
    }
  ));
});
