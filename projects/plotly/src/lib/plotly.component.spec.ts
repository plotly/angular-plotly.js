...
describe('PlotlyComponent', () => {
  ...
  it('should update when change the revision number', () => {
    ...
    component.ngOnChanges({
      revision: new SimpleChange(null, component.revision, true),
    });
    fixture.detectChanges();
    ...
    component.ngOnChanges({
      revision: new SimpleChange(0, component.revision, false),
    });
    fixture.detectChanges();
    ...
    component.ngOnChanges({
      revision: new SimpleChange(1, component.revision, false),
    });
    fixture.detectChanges();
  ...
  it('should add the gd property to window when passing true to debug', (done) => {
    ...
    fixture.detectChanges();
    component.ngOnChanges({
      debug: new SimpleChange(false, component.debug, false),
    });
  ...
  it('should clear all added window events on destroy', async (done) => {
    ...
    expect((window as any).eventListeners().length).toEqual(
      windowListenerCount
    );
